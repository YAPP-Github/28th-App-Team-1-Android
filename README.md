...
> D-14는 이직 예정자 또는 취업 준비생의 면접 준비를 돕는 서비스예요.

이 저장소는 [기업형 IT 연합 동아리 YAPP](https://github.com/YAPP-Github) 28기의 서비스 중 하나인 **D-14**의 Android 앱 코드
저장소예요.

D-14는 면접까지 14일, 즉 **2주의 기간** 동안 실전처럼 연습하고, AI와 지인 피드백을 함께 보고서로 종합해 면접자의 개선점을 정리할 수 있게 도와요.
