 ...
 * - FeedbackShare create API 400: [EMPTY_ATTITUDE_AXES], [TOO_MANY_ATTITUDE_AXES],
 *   [INVALID_ATTITUDE_AXIS]
 * - FeedbackShare create/update API 404: [FEEDBACK_SHARE_NOT_FOUND], [INTERVIEW_SESSION_NOT_FOUND]
 * - FeedbackShare create API 409: [FEEDBACK_SHARE_ALREADY_EXISTS]
 * - FeedbackShare update API 400: [INVALID_SHARE_STATUS]
