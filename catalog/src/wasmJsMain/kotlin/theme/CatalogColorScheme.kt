...
internal val CatalogLightColorScheme: ColorScheme =
    lightColorScheme(
...
internal val CatalogDarkColorScheme: ColorScheme =
    darkColorScheme(
        primary = primaryDark,
...
internal fun getCatalogColorScheme(isDark: Boolean): ColorScheme =
    if (isDark) CatalogDarkColorScheme else CatalogLightColorScheme
