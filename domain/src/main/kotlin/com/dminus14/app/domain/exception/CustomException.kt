...
class NetworkUnavailableException(
    ...
    cause: Throwable? = null,
) : CustomException(errCode = ERR_CODE, message = message, cause = cause) {
    companion object {
